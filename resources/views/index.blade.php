    ...
    <div class="w3-content" style="max-width:1532px;">
      ...
      <div class="w3-row-padding w3-padding-16">
        <div class="w3-third w3-margin-bottom">
          ...
          <div class="w3-container w3-white">
            <h3>Single Room</h3>
            <h6 class="w3-opacity">From Rs1000</h6>
            <p>Single bed</p>
            <p>15m<sup>2</sup></p>
        ...
        <div class="w3-third w3-margin-bottom">
          ...
          <div class="w3-container w3-white">
            <h3>Double Room</h3>
            <h6 class="w3-opacity">From Rs1490</h6>
            <p>Queen-size bed</p>
            <p>25m<sup>2</sup></p>
        ...
        <div class="w3-third w3-margin-bottom">
          ...
          <div class="w3-container w3-white">
            <h3>Deluxe Room</h3>
            <h6 class="w3-opacity">From Rs4199</h6>
            <p>King-size bed</p>
            <p>40m<sup>2</sup></p>
      ...
      <div class="w3-row-padding" id="about">
        <div class="w3-col l4 12">
          <h3>About</h3>
          <h6>Choose from a wide range of properties which Booking.com offers. Search now! Book your Hotel in Mumbai online. No reservation costs. Great rates. Secure Booking. Bed and Breakfasts. Save 10% with Genius. Apartments.        <p>We accept: <i class="fa fa-credit-card w3-large"></i> <i class="fa fa-cc-mastercard w3-large"></i> <i class="fa fa-cc-amex w3-large"></i> <i class="fa fa-cc-cc-visa w3-large"></i><i class="fa fa-cc-paypal w3-large"></i></p>
        </div>
      ...
      <div class="w3-row-padding w3-padding-16 w3-text-white w3-large">
        <div class="w3-half w3-margin-bottom">
          <div class="w3-display-container">
            ...
            <span class="w3-display-bottomleft w3-padding">Pune
            </span>
          </div>
        </div>
        <div class="w3-half">
          ...
          <div class="w3-row-padding" style="margin:0 -16px">
            <div class="w3-half w3-margin-bottom">
              <div class="w3-display-container">
                ...
                <span class="w3-display-bottomleft w3-padding">Austrelia</span>
              </div>
            </div>
            <div class="w3-half w3-margin-bottom">
              <div class="w3-display-container">
                <img src="/paris.jpg" alt="Paris" style="width:100%">
                <span class="w3-display-bottomleft w3-padding">Ladhak</span>
              </div>
            </div>
          </div>
        </div>
